...
val primaryContainerLight = Color(0xFFF5F5F5)
val onPrimaryContainerLight = Color(0xFF000000)

val secondaryLight = Color(0xFF454545)
...
val tertiaryContainerLight = Color(0xFFF8F8F8)
...
val outlineLight = Color(0xFFCACACA)
